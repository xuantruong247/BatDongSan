...
import notfound from "../../assets/images/notfount.svg";
...
const NotFound404 = () => {
  return (
    <div className="w-full flex flex-col py-6 items-center gap-12">
      ...
      <Link to={`/${path.TRANGCHU}`} className="bg-black py-2 text-white w-[100px] flex justify-center rounded-lg">Go back</Link>
    </div>
  );
};
