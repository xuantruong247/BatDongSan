...
const GioiThieu = () => {
  return (
    <div className="w-full">
      <CarouselOutLet />
      <div className="flex text-main w-[1050px] mx-auto px-[20px]">
        <div className="flex flex-col gap-4 text-[19px] mb-10 text-justify">
          <h1 className="mt-32 text-[40px] font-medium flex justify-center">
